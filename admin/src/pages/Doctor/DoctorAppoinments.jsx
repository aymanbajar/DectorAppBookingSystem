      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll'>
        ...
        </div>
        {
          appointments.reverse().map((item,index) => (
            <div 
            className='flex flex-wrap  justify-between max-sm:gap-5 max-sm:text-bas sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr]  gap-1 items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50'
            key={index}>
              ...
              {
                item.cancelled 
                ? <p className="text-red-500 font-medium">İptal Edildi</p>
                : item.isCompleted
                  ? <p className="text-green-500 font-medium">Tamamlandı</p>
                  : <div className='flex'>
