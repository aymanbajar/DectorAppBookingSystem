    ...
    <section className="admin-page">
      ...
      <form onSubmit={onSubmitHandler} className="admin-card max-w-5xl p-6">
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          <label><span className="mb-2 block text-sm font-semibold text-slate-700">Uzmanlık Alanı</span><select onChange={(e) => setSpeciality(e.target.value)} value={speciality} className="admin-input"><option>Pratisyen Hekim</option><option>Dermatoloji</option><option>Nöroloji</option><option>Kadın Doğum Uzmanı</option><option>Psikiyatri</option><option>Çocuk Doktoru</option><option>Üroloji</option></select></label>
